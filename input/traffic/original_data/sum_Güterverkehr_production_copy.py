...
# production_per_land_his_alu = load_excel_sheet(r'N:\Projekte\IPP\08 Daten\Nachfrage\Nachfragemodell\endemo2\preprocessing\traffic', 'ProduktionsmengeGüterverkehr.xlsx','Aluminium')

# production_per_land_his_cem = load_excel_sheet(r'N:\Projekte\IPP\08 Daten\Nachfrage\Nachfragemodell\endemo2\preprocessing\traffic', "ProduktionsmengeGüterverkehr.xlsx",'Cement')

# production_per_land_his_glas = load_excel_sheet(r'N:\Projekte\IPP\08 Daten\Nachfrage\Nachfragemodell\endemo2\preprocessing\traffic', "ProduktionsmengeGüterverkehr.xlsx",'Glas')

# production_per_land_his_pa = load_excel_sheet(r'N:\Projekte\IPP\08 Daten\Nachfrage\Nachfragemodell\endemo2\preprocessing\traffic', "ProduktionsmengeGüterverkehr.xlsx",'Paper')

# production_per_land_his_steel = load_excel_sheet(r'N:\Projekte\IPP\08 Daten\Nachfrage\Nachfragemodell\endemo2\preprocessing\traffic', "ProduktionsmengeGüterverkehr.xlsx",'Steel')
...
production.to_excel(r'N:\Projekte\IPP\08 Daten\Nachfrage\Nachfragemodell\endemo\input\traffic\Productionvolume_2050.xlsx', index=False)
