...
# production_per_land_his_alu = load_excel_sheet(r'N:\Projekte\IPP\08 Daten\Nachfrage\Nachfragemodell\endemo2\input\traffic', 'ProduktionsmengeGüterverkehr_2050.xlsx','Aluminium')

# production_per_land_his_cem = load_excel_sheet(r'N:\Projekte\IPP\08 Daten\Nachfrage\Nachfragemodell\endemo2\input\traffic', "ProduktionsmengeGüterverkehr_2050.xlsx",'Cement')

# production_per_land_his_glas = load_excel_sheet(r'N:\Projekte\IPP\08 Daten\Nachfrage\Nachfragemodell\endemo2\input\traffic', "ProduktionsmengeGüterverkehr_2050.xlsx",'Glas')

# production_per_land_his_pa = load_excel_sheet(r'N:\Projekte\IPP\08 Daten\Nachfrage\Nachfragemodell\endemo2\input\traffic', "ProduktionsmengeGüterverkehr_2050.xlsx",'Paper')

# production_per_land_his_steel = load_excel_sheet(r'N:\Projekte\IPP\08 Daten\Nachfrage\Nachfragemodell\endemo2\input\traffic', "ProduktionsmengeGüterverkehr_2050.xlsx",'Steel')

# production_per_land_his_amm = load_excel_sheet(r'N:\Projekte\IPP\08 Daten\Nachfrage\Nachfragemodell\endemo2\input\traffic', "ProduktionsmengeGüterverkehr_2050.xlsx",'Ammonium')
