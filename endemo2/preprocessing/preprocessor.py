...
from endemo2.utility.prediction_models import Coef
from endemo2.utility.utility_containers import ForecastMethod


class Preprocessor:

    def __init__(self, input_manager: input.Input):
        self.input_manager = input_manager
        self.group_manager = GroupManager(input_manager)
...
class GroupManager:
    ...
    class ProductGroupCoefficients:
        ...
        def __init__(self, country_joined_group_map: dict, separate: set[str], joined: [(Coef, [str])], joined_div: dict):
