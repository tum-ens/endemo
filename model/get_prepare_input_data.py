...
class GENERAL():
    ...
    def __init__(self, CTRL, FILE):
        ...
        self.nuts_codes = pd.read_excel(os.path.join(FILE.FILE_PATH_INPUT_DATA_GENERAL, "Subregion_classification.xlsx"),
                                        sheet_name=["Data"],skiprows=0)["Data"]
        
        # Population data
        self.pop_table = pd.read_excel(os.path.join(FILE.FILE_PATH_INPUT_DATA_GENERAL, "Population_historical_world.xls"),
                                       sheet_name=["Data"],skiprows=0)["Data"]
        self.pop_nuts2_table = pd.read_csv(os.path.join(FILE.FILE_PATH_INPUT_DATA_GENERAL, "Population_historical_subregion.csv"),
        ...
        if CTRL.NUTS2_ACTIVATED and CTRL.POP_ACTIVATED:
            ...
            self.pop_forecast = pd.read_excel(os.path.join(FILE.FILE_PATH_INPUT_DATA_GENERAL, "Population_projection_world.xlsx"),
                                              sheet_name=["Population_Subregion","Population_Countries"],skiprows=0)
        ...
        self.GDP_prognosis = pd.read_excel(os.path.join(FILE.FILE_PATH_INPUT_DATA_GENERAL, "GDP_per_capita_projection.xlsx"),
                                           sheet_name=["Data"],skiprows=0)["Data"]
...
class INDUSTRY():
    ...
    def __init__(self, CTRL, FILE):
        ...
        # for sector in ["Aluminium", "Copper"]:
        #     setattr(self, sector.lower() + "_table", 
        #             pd.read_excel(os.path.join(FILE.FILE_PATH_INPUT_DATA_INDUSTRY, "Production_"+sector".xlsx"),sheet_name=["Data_total"],skiprows=0)["Data_total"]
        ...
        self.copper_table = self.copper_table[self.copper_table["Type"]=="Total"].reset_index()
        self.copper_table = self.copper_table.drop(["index", "Type"],axis= 1)
        ...
        self.olefins_table = pd.read_excel(os.path.join(FILE.FILE_PATH_INPUT_DATA_INDUSTRY, "Production_Olefins.xlsx"),sheet_name=["Data"],skiprows=0)["Data"]
        ...
        self.spec_consum_BAT=pd.read_excel(os.path.join(FILE.FILE_PATH_INPUT_DATA_INDUSTRY, "Specific_Consumption_BAT.xlsx"),
                                             sheet_name=None,skiprows=0)
        self.installed_capacity_NUTS2=pd.read_excel(os.path.join(FILE.FILE_PATH_INPUT_DATA_INDUSTRY, "Installed_capacity_subregion.xlsx"),
